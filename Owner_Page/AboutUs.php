...
.wel h1{font-weight:700; color:#fff}.brk{height:4px; border-radius:4px; background:#004080; margin:25px auto; display:block; width:60px}
...
#footer{background:#00a5ff; padding-top:30px; padding-bottom:30px; text-align:center; border-top:solid 4px #303}
...
<h1>Heavy Vehicle Registration</h1>
<span style="color:#004080" class="brk"></span>
<p>We here to keep Lorries loaded, freight moving and India's trucking/lorry industry chugging along at a happy, healthy pace. We're committed to providing instant load board access to Lorry owners, truckers and Lorry brokers with cutting-edge technology that's user-friendly, economical, fast, and secure.</p>
...
<h2>Who We Are?</h2>
<span style="color:#004080" class="brk"></span>
<p>Our mission over the coming years is to become the networking portal for the transport sector. We hope to allow all logistics businesses to work more closely, effectively and efficiently, using us as their trusted Indian transport marketplace.</p>
...
<div class="row">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="../Images/600x400.png" alt="about us page design using bootstrap">
       <img class="team-pic" src="../Images/myAvatar.png">
      <div class="caption">
        <h3>Chintu Yadav</h3>
        <p class="card-description"> </p>
        <p class="social"><a href=""><i class="fa fa-facebook"></i></a> <a href=""><i class="fa fa-twitter"></i></a> <a href=""><i class="fa fa-linkedin"></i></a> <a href=""><i class="fa fa-google-plus"></i></a></p>
