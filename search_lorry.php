...
mysql_select_db("selab",$cn)  or die("Could not connect to Database");
	...
	$query="select * from registration where Source='$src' and Destination= '$dst' and Date='$date'";
	//echo $query;
	$rs=mysql_query($query);
    $count=mysql_num_rows($rs);

//    die('<br>'.mysql_error().$query);
    if($count>=1){
				...
				echo "
					...
					<td><strong>  $row1[2] </strong></td>
					<td><strong> &#8377 $row1[10] /ton </strong></td>
					...
					<div class='modal fade' id='$row1[6]'>
						<div class='modal-dialog' >
							<div class='modal-content col col-md-offset-1 col-md-10' >
									...
									<div class='row'>
										<div class='col-sm-8'>
											<p>Owner Name: <strong>$row1[2]</strong></p1>
											<p>Owner Email: <strong>$row1[1]</strong></p1>
									...
									<button class='btn btn-danger' data-toggle='modal' data-target='#$row1[6]' >Close</button>";
										if(isset($_SESSION['user_id'])){
											...
											echo "<button class='btn btn-primary disabled'>Book Now</button>";
    	...
    	echo "
    		<br>
    		<center><h1 class='jumbotron'>No Loads Available</h1>
    		<p><a href='index.php'>Click to go home</a></p>
    		<center>
